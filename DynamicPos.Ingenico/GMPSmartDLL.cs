...
namespace GmpSampleSim
{
    ...
    class Json_GMPSmartDLL
    {
        ...
        public static UInt32 FP3_GetExchangeTable(UInt32 hInt, ref int pNumberOfTotalRecords, ref int pNumberOfTotalRecordsReceived, ref ST_EXCHANGE[] pStExchange, int NumberOfRecordsRequested)
        {
            ...
            UInt32 retcode = Json_FP3_GetExchangeTable(hInt, ref pNumberOfTotalRecords, ref pNumberOfTotalRecordsReceived, szJsonExchangeTable_In, szJsonExchangeTable_Out, szJsonExchangeTable_Out.Length, NumberOfRecordsRequested);
